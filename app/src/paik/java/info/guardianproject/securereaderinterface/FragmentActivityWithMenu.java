...
public class FragmentActivityWithMenu extends LockableActivity implements FeedFilterViewCallbacks, OnCallbackListener {
    ...
    class UpdateLeftSideMenuTask extends ThreadedTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... values) {
            ...
            countInProgress = DownloadsAdapter.getNumInProgress();
            countPosts = App.getInstance().socialReporter.getPosts().size();
        ...
        protected void onPostExecute(Void result) {
            mMenuViewHolder.viewFeedFilter.updateList(feeds, countFavorites, countShared, countInProgress, countPosts);
