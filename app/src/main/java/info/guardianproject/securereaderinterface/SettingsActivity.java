...
public class SettingsActivity extends FragmentActivityWithMenu implements ICacheWordSubscriber, LayoutFactoryWrapper.Callback {
	...
	private void populateProfileTab()
	{
		...
		this.hookupRadioButtonWithArray(tabView, "passphraseTimeout", int.class, new ResourceValueMapping[] {
				new ResourceValueMapping(R.id.rbPassphraseTimeout1, 1),
				new ResourceValueMapping(R.id.rbPassphraseTimeout2, 60),
				new ResourceValueMapping(R.id.rbPassphraseTimeout3, 3600),
				new ResourceValueMapping(R.id.rbPassphraseTimeout4, 86400),
				new ResourceValueMapping(R.id.rbPassphraseTimeout5, 604800),});//Integer.MAX_VALUE / 60000), }); //MAX_INT milliseconds given in minutes
